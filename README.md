...
- **Images & emoji** — drop pictures, or press `/` for a quick emoji palette# macdraw
...
```bash
git clone [https://github.com/aadityakumarsah/macdraw.git](https://github.com/aadityakumarsah/macdraw.git)
cd macdraw
